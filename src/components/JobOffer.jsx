...
const JobOffer = () => {
    ...
    return (
        <div className='col-4' >
            ...
            <div className="card ">
                <div className="row">
                    <div className="logo ml-3 mb-3"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTxDRpxI5gXgaVmnO-VgcVUNOkca91jIpS75Flbzkz5W_5g5_V5&usqp=CAU" alt='' /></div>
   ...
   */}
                ...
                <div className="mutual"><i className="fas fa-users" />&nbsp;&nbsp;<span></span></div>
                <div className="row btnsubmit mt-4">
                    <div className="col-md-6 col-6">
                        <button type="button" onClick={() => window.location.href = '/condidacy'} className="btn btn-primary btn-lg"><span>Apply Now</span></button>
                    </div>
                    <div className="col-md-6 col-6">
