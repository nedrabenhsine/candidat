          ...
          <div className="row flex-center">
            ...
            <div className="col-md-5 text-center text-md-start">
              ...
              <p className="my-4 pe-xl-8">
                {" "}
                trouver un emploi qui correspond à vos intérêts et à vos
                talents. Un salaire élevé n'est pas la priorité absolue. Plus
                important encore, vous pouvez travailler selon le désir de votre
                cœur.
              </p>
            </div>
          </div>
